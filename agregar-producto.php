...
if (!isset($cestaActual[$productoId])) {
    $query = 'select p.producto_id, p.stock , p.descripcion , p.precio , p.imagen, p.nombre from productos p where p.producto_id = '.$productoId;
...
header('Location: http://localhost/osg/cesta.php');
